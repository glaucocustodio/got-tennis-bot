# Source: https://github.com/chaene82/tennisexplorer
...
# Disable the FutureWarning related to frame.append
...
def get_te_matchlist_all(year = now.strftime('%Y'), month = now.strftime('%m'), day = now.strftime('%d'), match_type="atp-single"):
    """
